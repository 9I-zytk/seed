<template>
  <div class="side-menu-wrapper">
    <slot></slot>
    <Menu ref="menu" v-show="false" :active-name="activeName" :open-names="openedNames" :accordion="accordion" :theme="theme" width="auto" @on-select="handleSelect">
    ...
    <div class="menu-collapsed" v-show="true" :list="menuList">
      <template v-for="item in menuList">
